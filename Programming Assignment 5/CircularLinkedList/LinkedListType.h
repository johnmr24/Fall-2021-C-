...
Type linkedListType<Type>::front() const
{
    ...
    return first->getInfo(); //return the info of the first node	
}//end front
...
Type linkedListType<Type>::back() const
{
    ...
    return last->getInfo(); //return the info of the last node	
}//end back
...
void linkedListType<Type>::copyList(const linkedListType<Type>& otherList)
{
    ...
    else
    {
        ...
        first->setInfo(current->getInfo());      //copy the info
        first->setInfo(NULL);        //set the link field of 
                                   //the node to NULL
        ...
        while (current != NULL)
        {
            ...
            newNode->setInfo(current->getInfo()); //copy the info
